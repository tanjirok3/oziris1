scoreboard players operation @s temp = @s ry

execute @s[scores={temp=128..}] ~ ~ ~ tp @s ~ ~ ~ ~128 ~
execute @s[scores={temp=128..}] ~ ~ ~ scoreboard players remove @s temp 128
...
execute @s[scores={temp=..-128}] ~ ~ ~ tp @s ~ ~ ~ ~-128 ~
execute @s[scores={temp=..-128}] ~ ~ ~ scoreboard players add @s temp 128
